...
path ='C:/Users/tusha/Downloads/Online Web Base/Online Web Base/static/json/products.json'
base='C:/Users/tusha/Downloads/Online Web Base/Online Web Base/static/json/'
...
def paymentForm():
    if 'email' not in session:
        ...
        return render_template('payment.html', error='')
